...
| `/zero-review:auto-env <goal>` | auto-env | Configure a runnable environment |
...
│   ├── auto-env/                      # Environment configuration and run contract
...
│   ├── auto-env.md                    # Environment configuration command
